                ...
                <Col lg="7" sm="6" >
                    <div className="blog">
                        <div className="blogPosts">
                            ...
                            <Button className="bg-light text-dark fw-bold topButton ">
                                INTERIOR
                            </Button>
                            <div className="blogContent">
                                ...
                                <h6>
                                    ...
                                    Placeat dolorem error eos aut dolore, autem eligendi. At amet
                                    doloribus eius eos impedit qui non ut quam. Consequuntur,
                                    nihil quidem. Voluptatem.{" "}
                                </h6>
                            </div>
                        </div>
                    ...
                    <Row className="mt-5">
                        ...
                        <Button className='bigButton'>Load More</Button>
                    </Row>
